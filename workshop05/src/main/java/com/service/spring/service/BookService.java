...
public class BookService {
	...
	public void insertBook(Book vo) throws Exception{	
		System.out.println("Service insertBook ================= " + vo);
	...
	public List<Book> searchByPrice(String searchText) throws Exception{
		List<Book> list = bookDAO.searchByPrice(searchText);
        return list;
	}
