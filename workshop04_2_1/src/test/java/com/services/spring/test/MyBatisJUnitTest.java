...
//		session.commit();
		...
		// findProductByName
//		List<MyProduct> listByName = session.selectList("ns.sql.MyProductMapper.findProductByName", "장고");
//		for(MyProduct i : listByName) System.out.println(i);
		
		// findProductByMaker
//		List<MyProduct> listByMaker = session.selectList("ns.sql.MyProductMapper.findProductByMaker", "G");
